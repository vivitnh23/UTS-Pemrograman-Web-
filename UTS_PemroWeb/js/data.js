...
// Data Awal Pemesanan (FALLBACK jika LocalStorage kosong)
var dataPemesanan = [
    { 
        nomorPesan: "P0001", tanggal: "2025-08-27", total: "Rp 180.000", status: "Selesai", 
        items: [{ kode: "ASIP4301", nama: "Pengantar Ilmu Komunikasi", jumlah: 1 }] 
    },
];

// 1. Data Pengguna (Untuk Login)
var dataPengguna = [
    {
        id: 1,
        nama: "Rina Wulandari",
